...
class Product(TimeStampedModel):
    ...
    def get_products_light(cls,
        ...
        if sponsored_organizations:
            products = (products.filter(organization__orgprofile_is_sponsored=True)
                        .select_related('organization'))
        if search_term:
        ...
        for product in products:
            product_data = {
                ...
                "product_theme_ids": [zone.design.theme.id for zone in product.product_designed_personalizable_variant.designed_personalizable_variant.designed_personalizable_zone.all()] if design_ids else None,
                "product_designs": [zone.design.id for zone in product.product_designed_personalizable_variant.designed_personalizable_variant.designed_personalizable_zone.all()] if design_ids else None
            }
