...
def insert_static_data(db):
    ...
    VALUES ({theme_data[0][1]}, {theme_data[0][2]}, {theme_data[0][3]}, {theme_data[0][4]})
    VALUES ({theme_data[1][1]}, {theme_data[1][2]}, {theme_data[1][3]}, {theme_data[1][4]})
    VALUES ({theme_data[2][1]}, {theme_data[2][2]}, {theme_data[2][3]}, {theme_data[2][4]})
    VALUES ({theme_data[3][1]}, {theme_data[3][2]}, {theme_data[3][3]}, {theme_data[3][4]})
    VALUES ({theme_data[4][1]}, {theme_data[4][2]}, {theme_data[4][3]}, {theme_data[4][4]})
    VALUES ({theme_data[5][1]}, {theme_data[5][2]}, {theme_data[5][3]}, {theme_data[5][4]})
    VALUES ({theme_data[6][1]}, {theme_data[6][2]}, {theme_data[6][3]}, {theme_data[6][4]})
    VALUES ({theme_data[7][1]}, {theme_data[7][2]}, {theme_data[7][3]}, {theme_data[7][4]})
    """
