...
def insert_static_data(db):
    ...
    category_data = [
        # Home decor
        ("14a70128-56f1-4881-a63d-e09636e812bd", "Home Decor", faker.image_url(), faker.image_url(),  None, "Available", faker.date_time(), faker.date_time()),
        ("9c75b9b7-f047-403b-a715-f99c0ef26283", "paintings",  faker.image_url(), faker.image_url(), "14a70128-56f1-4881-a63d-e09636e812bd","Available", faker.date_time(), faker.date_time()),
        ("ee6bf500-d74b-4510-8a0b-8a610111d619", "blankets",   faker.image_url(), faker.image_url(), "14a70128-56f1-4881-a63d-e09636e812bd","Available", faker.date_time(), faker.date_time()),
        ("59a77ce4-971a-46bd-8988-39080f0d9c25", "pillows",    faker.image_url(), faker.image_url(), "14a70128-56f1-4881-a63d-e09636e812bd","Available", faker.date_time(), faker.date_time()),
        
        # Tech accessories
        ("14a70128-56f1-4881-a63d-10963658123d", "Tech Accessories", faker.image_url(), faker.image_url(), None, "Available", faker.date_time(), faker.date_time()),
        ("79ee3fcf-42c2-4906-badf-8380904792dc", "Phone cases",      faker.image_url(), faker.image_url(), "14a70128-56f1-4881-a63d-10963658123d", "Available", faker.date_time(), faker.date_time()),
        ("13a603d6-704d-41e0-8adf-d5ef93582401", "Keychains",        faker.image_url(), faker.image_url(), "14a70128-56f1-4881-a63d-10963658123d","Available", faker.date_time(), faker.date_time()),
        
        # Apparel
        ("404bfdf7-b8c4-4d68-ae2b-9e42342b94c6", "Apparel", faker.image_url(), faker.image_url(), None,"Available", faker.date_time(), faker.date_time()),
        
        ("4c33772d-953d-483f-8111-a112af95d058", "Tops",        faker.image_url(), faker.image_url(), "404bfdf7-b8c4-4d68-ae2b-9e42342b94c6", "Available",faker.date_time(), faker.date_time()),
        ("bf97280e-cbc3-49ec-ad08-79618a01371b", "Tshirts",     faker.image_url(), faker.image_url(), "4c33772d-953d-483f-8111-a112af95d058","Available", faker.date_time(), faker.date_time()),
        ("aa32d550-4e9b-42a0-a6cd-f1062cebb0d0", "Sweatshirts", faker.image_url(), faker.image_url(), "4c33772d-953d-483f-8111-a112af95d058","Available", faker.date_time(), faker.date_time()),
        ("583bea11-39d4-4828-afc3-32b3f151d355", "Sweaters",    faker.image_url(), faker.image_url(), "4c33772d-953d-483f-8111-a112af95d058","Available", faker.date_time(), faker.date_time()),
        
        ("e88ba743-e8da-4ef2-91bb-75c164b62144", "Bottoms", faker.image_url(), faker.image_url(), "404bfdf7-b8c4-4d68-ae2b-9e42342b94c6","Available", faker.date_time(), faker.date_time()),
        ("5a253d03-f9f5-41ad-9fd5-4189451e1804", "Pants",   faker.image_url(), faker.image_url(), "e88ba743-e8da-4ef2-91bb-75c164b62144","Available", faker.date_time(), faker.date_time()),
        ("cb64c665-85f0-4ea6-91f9-4c296945ddd1", "Bras",    faker.image_url(), faker.image_url(), "e88ba743-e8da-4ef2-91bb-75c164b62144","Available", faker.date_time(), faker.date_time()),
        
        ("be2d099e-4bab-49b9-aab3-1d63463f384b", "Underwear",faker.image_url(), faker.image_url(), "404bfdf7-b8c4-4d68-ae2b-9e42342b94c6","Available", faker.date_time(), faker.date_time()),
        ("e2f98d5b-9679-4db5-a7d2-1f71dd1bb441", "Boxers",   faker.image_url(), faker.image_url(), "be2d099e-4bab-49b9-aab3-1d63463f384b","Available", faker.date_time(), faker.date_time()),
 ]  
    cursor = db.cursor()
    ...
    # Designs
    # prepare the data : id, collection_id, theme_id, title, description, price, image_path, tags, status(pending, approved, rejected), to_be_published, exclusive_usage, limited_personalizables, created_at, updated_at
    design_data = [
        ("e8be8bc6-4ae8-4264-9907-0fe4ca590018", "c41526d6-d0ae-456c-8cf5-0c549e4eac42", "14a70128-56f1-4881-a63d-e09636e812bd", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True) , faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        ("e00f0078-fc7e-41fc-a00d-1c8439387b0d", "c41526d6-d0ae-456c-8cf5-0c549e4eac42", "14a70128-56f1-4881-a63d-e09636e812bd", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True), faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        ("1030c335-8329-418e-ac7c-5e2eefec01b4", "c41526d6-d0ae-456c-8cf5-0c549e4eac42", "14a70128-56f1-4881-a63d-e09636e812bd", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True),  faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        ("3ace0690-484e-41d8-a766-1546caab1eed", "c41526d6-d0ae-456c-8cf5-0c549e4eac42", "14a70128-56f1-4881-a63d-e09636e812bd", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True), faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        ("24c0323e-82ec-4b58-8979-db2dddeba166", "c41526d6-d0ae-456c-8cf5-0c549e4eac42", "14a70128-56f1-4881-a63d-e09636e812bd", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True) ,faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        
        ("0eac82cc-975e-485b-998b-08bc148befed", "5ff408e7-60b7-4ff5-b9a2-cc012f3ae65c", "c407faaf-6fd5-4e32-bc32-002e39a8d89e", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True) ,faker.image_url(), faker.words(), "rejected", True, False, False, faker.date_time(), faker.date_time()),
        ("16cda768-851e-448f-8676-c4f5610e4693", "5ff408e7-60b7-4ff5-b9a2-cc012f3ae65c", "b1f59f7d-8ad2-4e02-92de-d3f0d879b821", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True) ,faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),

        ("2ae3295f-f884-407a-91f1-8c070f1958d4", "ed215c51-ef3f-40a6-ba25-61969efefff2", "afff6767-ab17-48c7-b0a6-a84f6ded9ff5", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True) ,faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        ("02a727c3-275f-431f-9865-6f984e3ccde1", "ed215c51-ef3f-40a6-ba25-61969efefff2", "240a1e1b-72b5-4a95-91e9-e223f6f9faa0", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True) ,faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),

        ("ba3f4983-98bb-41c6-98f7-ce945ccd1f49", "456310ce-0414-42cd-aeaa-9d89f024fd00", "d5623fd9-b017-4ff7-9e15-2f228e22b7e2", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True) ,faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        ("9cf24dd9-da10-48c0-9c7f-7925b5eda1cf", "456310ce-0414-42cd-aeaa-9d89f024fd00", "74745f05-fb8b-4217-a3c8-d00aa72d415d", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True) ,faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),

        ("dd568de2-6890-4e6b-8f77-69136edd13e7", "2a887af1-e4df-4b43-98d4-57fdd34cc427", "ec48f796-78cb-4c80-966f-b778bc85a2cc", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True), faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        ("72892788-17cd-4247-8a89-2e2dcbf1e407", "2a887af1-e4df-4b43-98d4-57fdd34cc427", "ec48f796-78cb-4c80-966f-b778bc85a2cc", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True), faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),

        ("103c4b2c-1324-4331-ac0b-42efb390de75", "2c714c80-4f83-4e7d-beed-6ceed76c8d18", "14a70128-56f1-4881-a63d-e09636e812bd", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True),faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        ("45324e5d-9a7d-4d24-8e70-781ca05846c6", "2c714c80-4f83-4e7d-beed-6ceed76c8d18", "c407faaf-6fd5-4e32-bc32-002e39a8d89e", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True),faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),

        ("8b3fa826-d998-48dc-b581-4f4e68d69fd2", "f2f21290-55c1-48f9-9dd8-bd68f4ec145a", "74745f05-fb8b-4217-a3c8-d00aa72d415d", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True),faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
        ("5cd84c45-879a-426a-a912-f595f52fbd06", "f2f21290-55c1-48f9-9dd8-bd68f4ec145a", "74745f05-fb8b-4217-a3c8-d00aa72d415d", faker.last_name(), faker.paragraph(), faker.pydecimal(left_digits=1, right_digits=0, positive=True),faker.image_url(), faker.words(), "approved", True, False, False, faker.date_time(), faker.date_time()),
    ]
    cursor = db.cursor()
    sql_query = "INSERT INTO designs (id, collection_id, theme_id, title, description, price, image_path, tags, status, to_be_published, exclusive_usage, limited_personalizables, created_at, updated_at) VAlUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) ON CONFLICT DO NOTHING"
