...
def insert_static_data(db):
    ...
    data = [
        ...
        # Apparel
        ("d316c531-855a-4a7a-9648-206e1ac8d621", "Apparel",  "image_path3", "logo_path3", None),
        ("d316c531-855a-4a7a-9648-206e1ac8d621", "Tops", "image_path1", "logo_path1", "d316c531-855a-4a7a-9648-206e1ac8d621"),
        ("14a70128-56f1-4881-a63d-10963658123d", "Bottoms", "image_path2", "logo_path2", "d316c531-855a-4a7a-9648-206e1ac8d621"),
        ("da07d4f3-64e9-4eaf-a99a-58cd9442af89", "Underwear","image_path3", "logo_path3", "d316c531-855a-4a7a-9648-206e1ac8d621"),
